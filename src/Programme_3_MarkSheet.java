...
public class Programme_3_MarkSheet {
     ...
     * message "Invalid Input, Marks should be 0 and 100") and find out total, percentage and result.
     * If he is pass to fail on basis of percentage (pass>35) and also give them grade if
     * %> = 80 A+ , %>=60 A, %>50 = B,%>= 35
     * And print Mark Sheet in the following format
