public class Programme_15_Wall {
    /**
     * Wall Area
     * Write a class with the name Wall. The class needs two fields (instance variables) with
     * name
     * <p>
     ...
     * and it needs to initialize the fields. In case the width is less than 0 it needs to set the width field value to 0, in case the
