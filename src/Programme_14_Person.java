public class Programme_14_Person {
     ...
     * the
     * lastName field.
     * *Method named setAge with one parameter of type int, it needs to set the value of the age
     * field. If
     ...
     * person. *In case both firstName and lastName fields are empty, Strings return an empty
     * String.
